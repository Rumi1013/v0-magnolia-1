      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24 bg-gradient-to-b from-magnolia-white via-sage-green/5 to-sage-green/20">
        <div className="container mx-auto px-4 text-center mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
            <Link
              href="/our-story"
              className="px-6 py-3 bg-rich-gold text-magnolia-white rounded-md font-accent text-sm hover:bg-rich-gold/90 transition-colors text-center group shadow-md hover:shadow-lg"
            >
