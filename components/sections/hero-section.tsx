  ...
  return (
    <section className="pt-32 pb-16 md:pt-40 md:pb-24 bg-gradient-to-b from-magnolia-white via-sage-green/5 to-sage-green/20">
      <div className="container mx-auto px-4 text-center mb-12">
        ...
        <h1 className="font-heading text-4xl md:text-5xl text-midnight-blue mb-4 drop-shadow-sm">Midnight Magnolia</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
          ...
          <CTAButton href="/shop" variant="outline" size="md">
            Explore Products
          </CTAButton>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-10">
          <div className="bg-midnight-blue/10 backdrop-blur-sm px-4 py-2 rounded-full flex items-center gap-2 shadow-md">
            <Sparkles className="h-4 w-4 text-rich-gold" />
            <span className="text-sm font-accent text-midnight-blue/90">ADHD-Friendly Design</span>
          </div>
          <div className="bg-midnight-blue/10 backdrop-blur-sm px-4 py-2 rounded-full flex items-center gap-2 shadow-md">
            <Heart className="h-4 w-4 text-rich-gold" />
            <span className="text-sm font-accent text-midnight-blue/90">Trauma-Informed Business</span>
          </div>
          <div className="bg-midnight-blue/10 backdrop-blur-sm px-4 py-2 rounded-full flex items-center gap-2 shadow-md">
            <Zap className="h-4 w-4 text-rich-gold" />
            <span className="text-sm font-accent text-midnight-blue/90">Automation for Liberation</span>
          </div>
        </div>
      </div>
    </section>
