...
export function AboutSection() {
  return (
    <section className="py-16 md:py-24 bg-magnolia-white text-midnight-blue">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-heading text-3xl md:text-4xl text-center mb-12 text-midnight-teal drop-shadow-lg">
            The Story Behind Midnight Magnolia
          </h2>

          <div className="bg-midnight-blue/10 p-8 rounded-lg border-l-4 border-rich-gold mb-12 shadow-lg transform hover:scale-102 transition-transform">
            <p className="font-heading text-xl italic text-midnight-blue/90">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-12">
            <div className="bg-magnolia-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-rich-gold/20">
              <h3 className="font-heading text-2xl text-midnight-teal mb-4 drop-shadow-md flex items-center gap-2">
                <Star className="h-5 w-5 text-rich-gold" />
                Origins in Transformation
              </h3>
              <p className="font-body text-midnight-blue/90 mb-4">
