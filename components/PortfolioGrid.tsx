...
// Default placeholder for portfolio images
const DEFAULT_PORTFOLIO_IMAGE = "/diverse-creative-portfolio.png"
...
const projects = [
  {
    ...
    imageUrl: "/interconnected-brand-elements.png",
    category: "Branding",
  },
  {
    id: 2,
    ...
    imageUrl: "/modern-web-design-concept.png",
    category: "Web Design",
  },
  {
    id: 3,
    ...
    imageUrl: "/connected-world-app.png",
    category: "Mobile App",
  },
  {
    id: 4,
    ...
    imageUrl: "/interconnected-digital-network.png",
  ...
  },
  {
    ...
    imageUrl: "/user-centered-design-flow.png",
    category: "UI/UX",
  },
  {
    id: 6,
    ...
    imageUrl: "/collaborative-design-process.png",
            ...
            {filteredProjects.map((project) => (
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  <Image
                    src={"/placeholder.svg?height=600&width=800&query=portfolio+" + project.title}
                    alt={project.title}
                    fill
