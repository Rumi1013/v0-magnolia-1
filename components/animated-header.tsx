    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        >
          ...
          <button
            className={`hidden md:block px-4 py-2 bg-rich-gold text-midnight-blue font-bold rounded-md font-accent text-sm hover:bg-rich-gold/90 transition-colors shadow-md hover:shadow-lg`}
          >
            Join Patron Portal
          </button>
